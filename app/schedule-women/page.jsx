...
export default function WomenMatches() {
    ...
    async function fetchData() {
      try {
        const matchRes = await fetch(
          "https://as-giannena-strapibackend.onrender.com/api/women-matches?populate=*&pagination[limit]=100"
        );
  ...
  return (
    <div className="matches-page">
      ...
      />
      <meta name="keywords" content="ΑΣ Γιάννενα, Αγώνες, Γυναίκες, Βόλεϊ" />
