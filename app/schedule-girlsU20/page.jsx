...
export default function GirlsU20Matches() {
    ...
    async function fetchData() {
      try {
        const [matchRes, teamRes] = await Promise.all([
          fetch(
            "https://as-giannena-strapibackend.onrender.com/api/girls-u20-matches?populate=*&pagination[limit]=100"
          ),
          fetch(
            "https://as-giannena-strapibackend.onrender.com/api/girls-u20-teams?populate=logo"
          ),
        ]);
        ...
        // Determine most recent matchday based on dates
        const now = new Date();
  ...
  return (
    <div className="matches-page">
      <title>ΑΣ Γιάννενα Βόλεϊ- Αγώνες Κορίτσια Κ20</title>
      <meta
        name="description"
        content="Δείτε τους αγώνες για την ομάδα των κοριτσιών Κ20 του ΑΣ Γιάννενα."
      />
      <meta
        name="keywords"
        content="ΑΣ Γιάννενα, Αγώνες, Κορίτσια, Κ20, Βόλεϊ"
      />

      <h1 className="matches-title">Αγώνες Κοριτσιών Κ20</h1>
