        ...
        <div className="footer-section footer-club-info">
          ...
          <div className="footer-text-content">
            ...
            <p className="footer-text">
              Ο Αθλητικός Σύλλογος Γιάννενα από το 2014 αναπτύσσει με συνέπεια
              και επαγγελματισμό το βόλεϊ στην περιοχή μας. Με έμπειρους
              προπονητές και οργανωμένες ακαδημίες, προωθούμε την αθλητική
              παιδεία, την ομαδικότητα και την εξέλιξη κάθε αθλητή, από τα πρώτα
              βήματα μέχρι την αγωνιστική διάκριση.
            </p>
          </div>
        </div>
