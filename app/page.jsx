  ...
  return (
    <div className="home">
      ...
      <section className="about">
        ...
        <p>
          Ο Αθλητικός Σύλλογος Γιάννενα από το 2014 αναπτύσσει με συνέπεια και
          επαγγελματισμό το βόλεϊ στην περιοχή μας. Με έμπειρους προπονητές και
          οργανωμένες ακαδημίες, προωθούμε την αθλητική παιδεία, την ομαδικότητα
