...
export default function BoysU18Matches() {
    ...
    async function fetchData() {
      try {
        const [matchRes, teamRes] = await Promise.all([
          fetch(
            "https://as-giannena-strapibackend.onrender.com/api/boys-u18-matches?populate=*&pagination[limit]=100"
          ),
          fetch(
            "https://as-giannena-strapibackend.onrender.com/api/boys-u18-teams?populate=logo"
          ),
        ]);
  ...
  return (
    <div className="matches-page">
      <title>ΑΣ Γιάννενα Βόλεϊ- Αγώνες Αγόρια Κ18</title>
      <meta
        name="description"
        content="Δείτε τους αγώνες για την ομάδα των αγοριών Κ18 του ΑΣ Γιάννενα."
      />
      <meta name="keywords" content="ΑΣ Γιάννενα, Αγώνες, Αγόρια, Κ18, Βόλεϊ" />

      <h1 className="matches-title">Αγώνες Αγοριών Κ18</h1>
