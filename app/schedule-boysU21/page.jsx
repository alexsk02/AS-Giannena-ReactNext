...
export default function BoysU21Matches() {
    ...
    async function fetchData() {
      try {
        const [matchRes, teamRes] = await Promise.all([
          fetch(
            "https://as-giannena-strapibackend.onrender.com/api/boys-u21-matches?populate=*&pagination[limit]=100"
          ),
          fetch(
        ...
        // Determine most recent matchday
        const now = new Date();
  ...
  return (
    <div className="matches-page">
      ...
      />
      <meta name="keywords" content="ΑΣ Γιάννενα, Αγώνες, Αγόρια, Κ21, Βόλεϊ" />

      <h1 className="matches-title">Αγώνες Αγοριών Κ21</h1>
